...
Collected research, memories, decisions, principles, guidelines, notes, and planning docs
about using Claude Code, optimizing Claude, using agents/sub-agents, and optimizing the
scope of rules, skills, and agents.
...
- **[global_CLAUDE.md](global_CLAUDE.md)** — from `~/.claude/CLAUDE.md`
- **[global_memory_MEMORY.md](global_memory_MEMORY.md)** — from `~/.claude/memory/MEMORY.md`
- **[global_memory_project-clones.md](global_memory_project-clones.md)** — from `~/.claude/memory/project-clones.md`

### 01-agenticdevteam-architecture

- **[agenticdevteam_CLAUDE.md](agenticdevteam_CLAUDE.md)** — from `~/projects/agenticdevteam/.claude/CLAUDE.md`
- **[agenticdevteam_architecture.md](agenticdevteam_architecture.md)** — from `~/projects/agenticdevteam/docs/architecture.md`
- **[agenticdevteam_project_description.md](agenticdevteam_project_description.md)** — from `~/projects/agenticdevteam/docs/project/description.md`

### 02-agenticdevteam-rules

- **[agenticdevteam_rule_always-commit-and-push.md](agenticdevteam_rule_always-commit-and-push.md)** — from `~/projects/agenticdevteam/.claude/rules/always-commit-and-push.md`
- **[agenticdevteam_rule_bump-versions.md](agenticdevteam_rule_bump-versions.md)** — from `~/projects/agenticdevteam/.claude/rules/bump-versions.md`
- **[agenticdevteam_rule_db-schema-design.md](agenticdevteam_rule_db-schema-design.md)** — from `~/projects/agenticdevteam/.claude/rules/db-schema-design.md`
- **[agenticdevteam_rule_optimize-subagent-dispatch.md](agenticdevteam_rule_optimize-subagent-dispatch.md)** — from `~/projects/agenticdevteam/.claude/rules/optimize-subagent-dispatch.md`
- **[agenticdevteam_rule_use-project-directories.md](agenticdevteam_rule_use-project-directories.md)** — from `~/projects/agenticdevteam/.claude/rules/use-project-directories.md`

### 03-agenticdevteam-research

- **[agenticdevteam_research_agent-patterns.md](agenticdevteam_research_agent-patterns.md)** — from `~/projects/agenticdevteam/docs/research/agent-patterns.md`
- **[agenticdevteam_research_claude-cost-optimization.md](agenticdevteam_research_claude-cost-optimization.md)** — from `~/projects/agenticdevteam/docs/research/claude-cost-optimization-research.md`
- **[agenticdevteam_research_conversational-patterns.md](agenticdevteam_research_conversational-patterns.md)** — from `~/projects/agenticdevteam/docs/research/conversational-patterns.md`
- **[agenticdevteam_research_persona-design.md](agenticdevteam_research_persona-design.md)** — from `~/projects/agenticdevteam/docs/research/persona-design.md`

### 04-agenticdevteam-planning

- **[agenticdevteam_planning_2026-04-02-lint-skill-migration.md](agenticdevteam_planning_2026-04-02-lint-skill-migration.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-02-lint-skill-migration.md`
- **[agenticdevteam_planning_2026-04-02-performance-optimization.md](agenticdevteam_planning_2026-04-02-performance-optimization.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-02-performance-optimization.md`
- **[agenticdevteam_planning_2026-04-02-single-router-skill.md](agenticdevteam_planning_2026-04-02-single-router-skill.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-02-single-router-skill.md`
- **[agenticdevteam_planning_2026-04-03-system-architecture-v2.md](agenticdevteam_planning_2026-04-03-system-architecture-v2.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-03-system-architecture-v2.md`
- **[agenticdevteam_planning_2026-04-04-dev-team-project.md](agenticdevteam_planning_2026-04-04-dev-team-project.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-04-dev-team-project.md`
- **[agenticdevteam_planning_2026-04-04-ralph-loop-specialist-analysis.md](agenticdevteam_planning_2026-04-04-ralph-loop-specialist-analysis.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-04-ralph-loop-specialist-analysis.md`
- **[agenticdevteam_planning_2026-04-04-specialty-team-extraction-plan.md](agenticdevteam_planning_2026-04-04-specialty-team-extraction-plan.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-04-specialty-team-extraction-plan.md`
- **[agenticdevteam_planning_2026-04-11-conductor-architecture.md](agenticdevteam_planning_2026-04-11-conductor-architecture.md)** — from `~/projects/agenticdevteam/docs/planning/2026-04-11-conductor-architecture.md`
- **[agenticdevteam_planning_build-history.md](agenticdevteam_planning_build-history.md)** — from `~/projects/agenticdevteam/docs/planning/build-history.md`
- **[agenticdevteam_planning_cookbook-requests.md](agenticdevteam_planning_cookbook-requests.md)** — from `~/projects/agenticdevteam/docs/planning/cookbook-requests.md`
- **[agenticdevteam_planning_design-spec.md](agenticdevteam_planning_design-spec.md)** — from `~/projects/agenticdevteam/docs/planning/design-spec.md`
- **[agenticdevteam_planning_unified-test-strategy-design.md](agenticdevteam_planning_unified-test-strategy-design.md)** — from `~/projects/agenticdevteam/docs/planning/unified-test-strategy-design.md`
- **[agenticdevteam_planning_unified-test-strategy-plan.md](agenticdevteam_planning_unified-test-strategy-plan.md)** — from `~/projects/agenticdevteam/docs/planning/unified-test-strategy-plan.md`

### 05-agenticdevteam-superpowers

- **[agenticdevteam_sp_plan_2026-04-04-crash-recovery.md](agenticdevteam_sp_plan_2026-04-04-crash-recovery.md)** — from `~/projects/agenticdevteam/docs/superpowers/plans/2026-04-04-crash-recovery.md`
- **[agenticdevteam_sp_plan_2026-04-04-specialty-team-extraction.md](agenticdevteam_sp_plan_2026-04-04-specialty-team-extraction.md)** — from `~/projects/agenticdevteam/docs/superpowers/plans/2026-04-04-specialty-team-extraction.md`
- **[agenticdevteam_sp_plan_2026-04-06-consulting-team.md](agenticdevteam_sp_plan_2026-04-06-consulting-team.md)** — from `~/projects/agenticdevteam/docs/superpowers/plans/2026-04-06-consulting-team.md`
- **[agenticdevteam_sp_plan_2026-04-06-observer-stenographer.md](agenticdevteam_sp_plan_2026-04-06-observer-stenographer.md)** — from `~/projects/agenticdevteam/docs/superpowers/plans/2026-04-06-observer-stenographer.md`
- **[agenticdevteam_sp_plan_2026-04-08-team-pipeline.md](agenticdevteam_sp_plan_2026-04-08-team-pipeline.md)** — from `~/projects/agenticdevteam/docs/superpowers/plans/2026-04-08-team-pipeline.md`
- **[agenticdevteam_sp_spec_2026-04-04-crash-recovery-design.md](agenticdevteam_sp_spec_2026-04-04-crash-recovery-design.md)** — from `~/projects/agenticdevteam/docs/superpowers/specs/2026-04-04-crash-recovery-design.md`
- **[agenticdevteam_sp_spec_2026-04-06-consulting-team-design.md](agenticdevteam_sp_spec_2026-04-06-consulting-team-design.md)** — from `~/projects/agenticdevteam/docs/superpowers/specs/2026-04-06-consulting-team-design.md`
- **[agenticdevteam_sp_spec_2026-04-06-database-specialist-design.md](agenticdevteam_sp_spec_2026-04-06-database-specialist-design.md)** — from `~/projects/agenticdevteam/docs/superpowers/specs/2026-04-06-database-specialist-design.md`
- **[agenticdevteam_sp_spec_2026-04-06-observer-stenographer-design.md](agenticdevteam_sp_spec_2026-04-06-observer-stenographer-design.md)** — from `~/projects/agenticdevteam/docs/superpowers/specs/2026-04-06-observer-stenographer-design.md`
...
- **[agenticdevteam_plugin_dev-team_application-map-spec.md](agenticdevteam_plugin_dev-team_application-map-spec.md)** — from `~/projects/agenticdevteam/plugins/dev-team/docs/application-map-spec.md`
- **[agenticdevteam_plugin_dev-team_research_cookbook-specialist-mapping.md](agenticdevteam_plugin_dev-team_research_cookbook-specialist-mapping.md)** — from `~/projects/agenticdevteam/plugins/dev-team/docs/research/cookbook-specialist-mapping.md`
- **[agenticdevteam_plugin_dev-team_research_specialist-assignment.md](agenticdevteam_plugin_dev-team_research_specialist-assignment.md)** — from `~/projects/agenticdevteam/plugins/dev-team/docs/research/specialist-assignment.md`
- **[agenticdevteam_plugin_dev-team_specialist-guide.md](agenticdevteam_plugin_dev-team_specialist-guide.md)** — from `~/projects/agenticdevteam/plugins/dev-team/docs/specialist-guide.md`
- **[agenticdevteam_plugin_dev-team_specialist-spec.md](agenticdevteam_plugin_dev-team_specialist-spec.md)** — from `~/projects/agenticdevteam/plugins/dev-team/docs/specialist-spec.md`
- **[agenticdevteam_plugin_team-pipeline_consulting-team-spec.md](agenticdevteam_plugin_team-pipeline_consulting-team-spec.md)** — from `~/projects/agenticdevteam/plugins/team-pipeline/docs/consulting-team-spec.md`
...
- **[cookbook_claude_dangerously-skip-permissions-bugs.md](cookbook_claude_dangerously-skip-permissions-bugs.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/dangerously-skip-permissions-bugs.md`
- **[cookbook_claude_hooks-patterns.md](cookbook_claude_hooks-patterns.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/hooks-patterns.md`
- **[cookbook_claude_integration-guide.md](cookbook_claude_integration-guide.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/claude-integration-guide.md`
- **[cookbook_claude_mcp-servers.md](cookbook_claude_mcp-servers.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/mcp-servers.md`
- **[cookbook_claude_memory-and-context-tools.md](cookbook_claude_memory-and-context-tools.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/memory-and-context-tools.md`
- **[cookbook_claude_persona-prompting.md](cookbook_claude_persona-prompting.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/claude-persona-prompting.md`
- **[cookbook_claude_plugin-format.md](cookbook_claude_plugin-format.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/claude-plugin-format.md`
- **[cookbook_claude_plugins-and-skills-catalog.md](cookbook_claude_plugins-and-skills-catalog.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/plugins-and-skills-catalog.md`
- **[cookbook_claude_rule-optimization.md](cookbook_claude_rule-optimization.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/rule-optimization.md`
- **[cookbook_claude_self-healing-research-summary.md](cookbook_claude_self-healing-research-summary.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/self-healing-research-summary.md`
- **[cookbook_claude_skill-testing-landscape.md](cookbook_claude_skill-testing-landscape.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/skill-testing-landscape.md`
- **[cookbook_claude_terminal-progress-and-status-line.md](cookbook_claude_terminal-progress-and-status-line.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/terminal-progress-and-status-line.md`
- **[cookbook_claude_yolo-per-session-design.md](cookbook_claude_yolo-per-session-design.md)** — from `~/projects/cookbook-web/cookbook/appendix/research/developer-tools/claude/yolo-per-session-design.md`

### 11-cookbook-skills-and-agents

- **[cookbook_skills-agents_agent-checklist.md](cookbook_skills-agents_agent-checklist.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/agent-checklist.md`
- **[cookbook_skills-agents_agent-structure-reference.md](cookbook_skills-agents_agent-structure-reference.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/agent-structure-reference.md`
- **[cookbook_skills-agents_authoring-skills-and-rules.md](cookbook_skills-agents_authoring-skills-and-rules.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/authoring-skills-and-rules.md`
- **[cookbook_skills-agents_performance.md](cookbook_skills-agents_performance.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/performance.md`
- **[cookbook_skills-agents_rule-checklist.md](cookbook_skills-agents_rule-checklist.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/rule-checklist.md`
- **[cookbook_skills-agents_rule-structure-reference.md](cookbook_skills-agents_rule-structure-reference.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/rule-structure-reference.md`
- **[cookbook_skills-agents_skill-checklist.md](cookbook_skills-agents_skill-checklist.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/skill-checklist.md`
- **[cookbook_skills-agents_skill-structure-reference.md](cookbook_skills-agents_skill-structure-reference.md)** — from `~/projects/cookbook-web/cookbook/guidelines/skills-and-agents/skill-structure-reference.md`

### 12-cookbook-decisions

- **[cookbook_decision_cookbook-project-format.md](cookbook_decision_cookbook-project-format.md)** — from `~/projects/cookbook-web/cookbook/appendix/decisions/cookbook-project-format.md`
- **[cookbook_decision_global-plugin-cleanup.md](cookbook_decision_global-plugin-cleanup.md)** — from `~/projects/cookbook-web/cookbook/appendix/decisions/global-plugin-cleanup.md`
- **[cookbook_decision_ingredient-recipe-hierarchy.md](cookbook_decision_ingredient-recipe-hierarchy.md)** — from `~/projects/cookbook-web/cookbook/appendix/decisions/ingredient-recipe-cookbook-hierarchy.md`
- **[cookbook_decision_rule-pipeline-architecture.md](cookbook_decision_rule-pipeline-architecture.md)** — from `~/projects/cookbook-web/cookbook/appendix/decisions/rule-pipeline-architecture.md`

### 13-cookbook-introduction

- **[cookbook_introduction_conventions.md](cookbook_introduction_conventions.md)** — from `~/projects/cookbook-web/cookbook/introduction/conventions.md`
- **[cookbook_introduction_getting-started.md](cookbook_introduction_getting-started.md)** — from `~/projects/cookbook-web/cookbook/introduction/getting-started.md`
- **[cookbook_introduction_glossary.md](cookbook_introduction_glossary.md)** — from `~/projects/cookbook-web/cookbook/introduction/glossary.md`

### 14-cookbook-code-quality

- **[cookbook_code-quality_atomic-commits.md](cookbook_code-quality_atomic-commits.md)** — from `~/projects/cookbook-web/cookbook/guidelines/code-quality/atomic-commits.md`
- **[cookbook_code-quality_bulk-operation-verification.md](cookbook_code-quality_bulk-operation-verification.md)** — from `~/projects/cookbook-web/cookbook/guidelines/code-quality/bulk-operation-verification.md`
- **[cookbook_code-quality_linting.md](cookbook_code-quality_linting.md)** — from `~/projects/cookbook-web/cookbook/guidelines/code-quality/linting.md`
- **[cookbook_code-quality_scope-discipline.md](cookbook_code-quality_scope-discipline.md)** — from `~/projects/cookbook-web/cookbook/guidelines/code-quality/scope-discipline.md`
- **[cookbook_compliance_best-practices.md](cookbook_compliance_best-practices.md)** — from `~/projects/cookbook-web/cookbook/compliance/best-practices.md`

### 20-cookbook-tools-rules

- **[cookbook-tools_rule_authoring-ground-rules.md](cookbook-tools_rule_authoring-ground-rules.md)** — from `~/projects/agentic-cookbook-tools/rules/authoring-ground-rules.md`
- **[cookbook-tools_rule_cookbook.md](cookbook-tools_rule_cookbook.md)** — from `~/projects/agentic-cookbook-tools/rules/cookbook.md`
- **[cookbook-tools_rule_extension-authoring.md](cookbook-tools_rule_extension-authoring.md)** — from `~/projects/agentic-cookbook-tools/rules/extension-authoring.md`
- **[cookbook-tools_rule_generated-cookbook-template.md](cookbook-tools_rule_generated-cookbook-template.md)** — from `~/projects/agentic-cookbook-tools/rules/generated-cookbook-template.md`
- **[cookbook-tools_rule_permissions.md](cookbook-tools_rule_permissions.md)** — from `~/projects/agentic-cookbook-tools/rules/permissions.md`
- **[cookbook-tools_rule_skill-authoring.md](cookbook-tools_rule_skill-authoring.md)** — from `~/projects/agentic-cookbook-tools/rules/skill-authoring.md`
- **[cookbook-tools_rule_skill-versioning.md](cookbook-tools_rule_skill-versioning.md)** — from `~/projects/agentic-cookbook-tools/rules/skill-versioning.md`

### 21-cookbook-tools-optimize

- **[cookbook-tools_skill_optimize-rules_SKILL.md](cookbook-tools_skill_optimize-rules_SKILL.md)** — from `~/projects/agentic-cookbook-tools/skills/optimize-rules/SKILL.md`
- **[cookbook-tools_skill_optimize-rules_checklist.md](cookbook-tools_skill_optimize-rules_checklist.md)** — from `~/projects/agentic-cookbook-tools/skills/optimize-rules/references/optimization-checklist.md`

### 22-cookbook-tools-lint

- **[cookbook-tools_skill_install-worktree-rule_reference.md](cookbook-tools_skill_install-worktree-rule_reference.md)** — from `~/projects/agentic-cookbook-tools/skills/install-worktree-rule/references/always-use-worktrees-and-prs.md`
- **[cookbook-tools_skill_lint-agent_SKILL.md](cookbook-tools_skill_lint-agent_SKILL.md)** — from `~/projects/agentic-cookbook-tools/skills/lint-agent/SKILL.md`
- **[cookbook-tools_skill_lint-agent_checklist.md](cookbook-tools_skill_lint-agent_checklist.md)** — from `~/projects/agentic-cookbook-tools/skills/lint-agent/references/agent-checklist.md`
- **[cookbook-tools_skill_lint-agent_structure-reference.md](cookbook-tools_skill_lint-agent_structure-reference.md)** — from `~/projects/agentic-cookbook-tools/skills/lint-agent/references/agent-structure-reference.md`
- **[cookbook-tools_skill_lint-skill_SKILL.md](cookbook-tools_skill_lint-skill_SKILL.md)** — from `~/projects/agentic-cookbook-tools/skills/lint-skill/SKILL.md`
- **[cookbook-tools_skill_lint-skill_checklist.md](cookbook-tools_skill_lint-skill_checklist.md)** — from `~/projects/agentic-cookbook-tools/skills/lint-skill/references/skill-checklist.md`
- **[cookbook-tools_skill_lint-skill_structure-reference.md](cookbook-tools_skill_lint-skill_structure-reference.md)** — from `~/projects/agentic-cookbook-tools/skills/lint-skill/references/skill-structure-reference.md`

### 30-other-projects-claude

- **[cat-herding_research_claude-code-usage-limits.md](cat-herding_research_claude-code-usage-limits.md)** — from `~/projects/cat-herding/docs/research/claude-code-usage-limits.md`
- **[dev-tools_research_claude-code-plugins.md](dev-tools_research_claude-code-plugins.md)** — from `~/projects/dev-tools/docs/research/claude-code-plugins.md`

### 31-agent-registry

- **[agent-registry_research_ai-persona-research.md](agent-registry_research_ai-persona-research.md)** — from `~/projects/official-agent-registry/docs/research/ai-persona-research.md`
- **[agent-registry_research_ai-persona-template.md](agent-registry_research_ai-persona-template.md)** — from `~/projects/official-agent-registry/docs/research/ai-persona-template.md`
- **[agent-registry_research_deployment-guide.md](agent-registry_research_deployment-guide.md)** — from `~/projects/official-agent-registry/docs/research/deployment-guide.md`
- **[agent-registry_research_overview.md](agent-registry_research_overview.md)** — from `~/projects/official-agent-registry/docs/research/official-agent-registry-overview.md`
- **[agent-registry_research_seo-domain-redirect-strategy.md](agent-registry_research_seo-domain-redirect-strategy.md)** — from `~/projects/official-agent-registry/docs/research/seo-domain-redirect-strategy.md`

### 32-roadmaps

- **[roadmaps_agent_implement-step.md](roadmaps_agent_implement-step.md)** — from `~/projects/roadmaps/agents/implement-step-agent.md`
- **[roadmaps_project_description.md](roadmaps_project_description.md)** — from `~/projects/roadmaps/docs/project/description.md`
- **[roadmaps_research_plugin-vs-install-script.md](roadmaps_research_plugin-vs-install-script.md)** — from `~/projects/roadmaps/research/2026-03-30-plugin-vs-install-script.md`
- **[roadmaps_rule_committing-rule.md](roadmaps_rule_committing-rule.md)** — from `~/projects/roadmaps/.claude/rules/committing-rule.md`
- **[roadmaps_rule_cookbook.md](roadmaps_rule_cookbook.md)** — from `~/projects/roadmaps/.claude/rules/cookbook.md`
- **[roadmaps_rule_roadmap-permissions-rule.md](roadmaps_rule_roadmap-permissions-rule.md)** — from `~/projects/roadmaps/.claude/rules/roadmap-permissions-rule.md`
- **[roadmaps_rule_roadmap-planning-rule.md](roadmaps_rule_roadmap-planning-rule.md)** — from `~/projects/roadmaps/.claude/rules/ROADMAP-PLANNING-RULE.md`
- **[roadmaps_rule_skill-versioning-rule.md](roadmaps_rule_skill-versioning-rule.md)** — from `~/projects/roadmaps/.claude/rules/skill-versioning-rule.md`

### 40-project-descriptions

- **[agentic-cookbook-tools_CLAUDE.md](agentic-cookbook-tools_CLAUDE.md)** — from `~/projects/agentic-cookbook-tools/.claude/CLAUDE.md`
- **[agentic-cookbook-tools_project_description.md](agentic-cookbook-tools_project_description.md)** — from `~/projects/agentic-cookbook-tools/docs/project/description.md`
- **[agentic-kitchen_project_description.md](agentic-kitchen_project_description.md)** — from `~/projects/agentic-kitchen/docs/project/description.md`
- **[agenticdeveloperhub_planning.md](agenticdeveloperhub_planning.md)** — from `~/projects/agenticdeveloperhub/docs/planning/planning.md`
- **[agenticdeveloperhub_project_description.md](agenticdeveloperhub_project_description.md)** — from `~/projects/agenticdeveloperhub/docs/project/description.md`
- **[cat-herding_project_description.md](cat-herding_project_description.md)** — from `~/projects/cat-herding/docs/project/description.md`
- **[myagenticprojects_project_description.md](myagenticprojects_project_description.md)** — from `~/projects/myagenticprojects/docs/project/description.md`
- **[myagenticworkspace_project_description.md](myagenticworkspace_project_description.md)** — from `~/projects/myagenticworkspace/docs/project/description.md`
- **[name-craft_project_description.md](name-craft_project_description.md)** — from `~/projects/name-craft/docs/project/description.md`
- **[persona-creator_planning.md](persona-creator_planning.md)** — from `~/projects/persona-creator/docs/planning/planning.md`
