...
domain: agentic-cookbook://guidelines/skills-and-agents/rule-checklist
type: guideline
version: 1.0.0
status: accepted
language: en
...
license: MIT
summary: "Comprehensive lint checklist for validating Claude Code rule file content quality, best practices, and optimization"
platforms: []
tags:
  - rules
  - linting
