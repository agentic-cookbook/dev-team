...
### Cookbook (TBD)
Project management recipes and guidelines will be added to the cookbook. Specialities will be updated to reference them when available.

## Manifest

- specialities/schedule.md
- specialities/todos.md
- specialities/issues.md
- specialities/concerns.md
- specialities/dependencies.md
- specialities/decisions.md
