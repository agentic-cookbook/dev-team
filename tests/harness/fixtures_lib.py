...
# tests/harness/fixtures_lib.py → go up two levels to reach repo root
_HARNESS_DIR = Path(__file__).parent
_TESTS_DIR = _HARNESS_DIR.parent

REPO_ROOT = _TESTS_DIR.parent  # dev-team repo root
...
def persona_path(name: str) -> str:
    """Resolve a persona filename to its absolute path under tests/personas/."""
    return str(_TESTS_DIR / "personas" / name)
