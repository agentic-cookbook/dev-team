...
# Import the storage-provider dispatcher
...
def main():
    ...
    # Arbitrator delegates to storage-provider
    # Future: add communication semantics here (state machine, routing)
    backend = os.environ.get("ARBITRATOR_BACKEND",
